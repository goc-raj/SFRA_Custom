...
//         // if (currentBasket.custom.useGiftCard == true) {
...
//     // var allProducts = currentBasket.allProductLineItems;
//     // var giftCertificate = []
//     // var gcCount = 0;
//     // var gcList = [];
...
//     //     if (allProducts[i].custom.isGiftCertificate == true) {
//     //         gcCount = gcCount + 1;
//     //         var gcObject = {
//     //             gcId : allProducts[i].productID,
//     //             gcAmount : allProducts[i].product.variationModel.selectedVariant.custom.size
//     //         }
//     //         gcList.push(gcObject);
//     //     }
//     // }

//     // for (let i = 0; i < gcList.length; i++) {
//     //     var number = gcList[i].gcAmount;
//     //     var stringToNumber = number.replace(/\$/g, '');
//     //     var amount = parseFloat(stringToNumber);
//     //     var gc = GiftCertificateMgr.createGiftCertificate(amount);
//     //     giftCertificate.push(gc);
//     // }
//     // //if(product.custom.isGiftCertificate == true) {
//     //     Transaction.begin();
//     //     var createdGiftCertificate = GiftCertificateMgr.createGiftCertificate(700);
//     //     createdGiftCertificate.setOrderNo(order.getCurrentOrderNo());
//     //     createdGiftCertificate.setRecipientEmail('raj.joshi@getoncrm.com');
//     //     createdGiftCertificate.setRecipientName('Raj Joshi');
//     //     createdGiftCertificate.setSenderName(profile.firstName + ' ' +  profile.lastName);
//     //     createdGiftCertificate.setMessage('sfysfjhasv');
//     //     Transaction.commit();
